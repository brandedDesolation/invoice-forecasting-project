        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {resources.map((resource, index) => {
            ...
            return (
              <div
                key={resource.title}
                className="group relative bg-white rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-bold text-black mb-3 leading-tight group-hover:text-gray-600 transition-colors">
                    {resource.title}
                  </h3>
