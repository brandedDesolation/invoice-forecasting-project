        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10">
              <a
                href="#"
                className="rounded-full bg-gradient-to-r from-primary-600 to-accent-600 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:shadow-xl transition-all hover:scale-105 inline-block"
              >
          ...
          <div className="relative">
            ...
            {/* Decorative element */}
            <div className="absolute -top-4 -right-4 -z-10 h-72 w-72 rounded-full bg-gradient-to-br from-primary-200 to-accent-200 opacity-20 blur-3xl" />
          </div>
        </div>
      </div>
    </section>
